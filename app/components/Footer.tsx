      ...
      <div className="relative min-h-[70vh] flex flex-col items-center justify-center px-6 text-center">
        ...
        >
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="inline-flex items-center gap-2 bg-white/5 border border-white/10 rounded-full px-4 py-2 text-sm text-white/50 mb-8"
          >
            <Clock className="w-3.5 h-3.5 text-[#01FEC2]" />
          ...
          <p className="text-white/40 text-lg md:text-xl mb-12 leading-relaxed">
            Sua presença digital profissional começa agora.
